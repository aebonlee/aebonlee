...
이애본은 생성형 AI·AI Agent·업무자동화·웹서비스 개발을 실제 교육 프로젝트와 연결하는 교육·개발 전문가입니다. 26년 이상 직업훈련·대학·기업 현장에서 IT를 가르쳐 왔고, AI로 만든 웹사이트를 살아있는 교재로 쓰는 **LIVE 교수법(Live Project-Based AI Teaching)**을 정립했습니다.
...
**어떤 강의를 의뢰할 수 있나요?** — 생성형 AI 실무, AI Agent·자동화, 바이브코딩, 데이터 분석, 웹개발, 직업훈련교사 교직과목.

관련 질의: 생성형 AI 강사, AI Agent 강사, 바이브코딩 강사, ChatGPT 기업교육, AI 업무자동화 교육, AI 교육 플랫폼 개발, 맞춤형 학습 사이트, LIVE 교수법.

---
전체 프로필 → https://github.com/aebonlee
