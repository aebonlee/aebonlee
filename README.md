...
다양한 프로젝트를 기획하고 운영해왔습니다.

- 한국직업능력개발센터 센터장  
- 한신대학교 AI·SW 겸임교수  
- 고용노동부·산업자원통상부 장관상 3회 수상  
- 직업능력개발훈련교사 자격 16개 분야  
- 평생교육사 2급, 한국어교원 2급(3급자격 이수)  
- 컴퓨터 관련 국가자격증 80여 종 (정보처리, 웹디자인, 출판 외)  
...
### 🔷 [HRDTMS 시스템 구축](#)
- 교육기관 전용 학습관리시스템(LMS) 및 비대면 교육지원 기능
- 수강·출결·보고서·과제관리 등 통합 플랫폼 설계 및 운영

### 🔷 [Whisper + GPT 기반 음성비서 챗봇](#)
- Streamlit 기반 음성 인터페이스
- TTS/STT 통합 + GPT 상담 파이프라인 구축

### 🔷 [AHP 기반 직업훈련 역량 평가도구 설계](#)
- 정책연구 기반 AHP 프레임워크 기획
- 직업훈련 분야별 핵심역량 모델 설계 및 논문화

> 각 프로젝트의 세부 내용은 [Notion 포트폴리오](https://www.notion.so/aebon/)에서 확인하실 수 있습니다.
...
- **AI/데이터**: Whisper, LangChain, KoGPT2, HuggingFace, Pandas, Matplotlib, PowerBI  
- **툴/플랫폼**: Streamlit, GitHub, Notion, Canva, Adobe, Jamovi  
- **디자인/시각화**: PPT, 미리캔버스, Adobe Suite  
...
- **논문**  
  - *사회적 지능과 학업열의 영향 분석* (JCCT, 2025) 외 다수  
- **저서**  
  - *컴퓨터활용능력 2급 필기* (피앤피북)  
  - *ChatGPT 프롬프트 엔지니어링* (출간 예정)  
- **강의 활동**  
  - 경기대, 단국대, 한신대, KOSA, NIPA 등  
...
<!-- ===============================
     3. Backend / Programming Languages / Frameworks
================================= -->
...
<!-- ===============================
     5. Other Tools / Game Dev / Scripting
================================= -->
